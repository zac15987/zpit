...
var en = map[Key]string{
	...
	KeyHistoryHotkey:                "History",
	KeyHistoryTitle:                 "History",
	KeyHistoryFolderListTitle:       "Encoded Folders — ~/.claude/projects/",
	KeyHistorySessionListTitle:      "Sessions — %s",
	KeyHistoryImportRow:             "[+] Import bundle...",
	KeyHistoryEmptyFolders:          "No encoded folders found",
	KeyHistoryEmptySessions:         "No sessions in this folder",
	KeyHistoryFolderRow:             "%d sessions  %s  %s",
	KeyHistorySelectedCount:         "%d selected",
	KeyHistoryFooterFolderList:      "Enter: open  [E]: export all  [i]: import  [Esc] back  [q] quit",
	KeyHistoryFooterSessionList:     "Space: select  [a]: toggle all  [e]: export  Enter: detail  [Esc] back",
	KeyHistoryDetailNotImplemented:  "Detail view coming in a follow-up issue",
	KeyHistoryActiveWarningTitle:    "Active session(s) detected",
	KeyHistoryActiveWarningBody:     "Session(s) %s currently active — exporting now may capture an incomplete tail. Continue?",
	KeyHistoryActiveWarningContinue: "Continue",
	KeyHistoryExportConfirmTitle:    "Export sessions",
	KeyHistoryExportConfirmBody:     "%d session(s), ~%s total",
	KeyHistoryExportIncludeMemory:   "Include memory/ directory",
	KeyHistoryExportPathLabel:       "Output path:",
	KeyHistoryExportButton:          "Export",
	KeyHistoryExportSuccess:         "Exported %d session(s) to %s",
	KeyHistoryExportFailure:         "Export failed: %s",
	KeyHistoryImportPathLabel:       "Bundle path:",
	KeyHistoryImportPreviewTitle:    "Bundle preview",
	KeyHistoryImportPreviewBody:     "Source: %s (%s)\n%d sessions  memory: %s",
	KeyHistoryImportDestLabel:       "Destination project path:",
	KeyHistoryImportFinalPreview:    "Will write to ~/.claude/projects/%s/, %d sessions, memory: %s",
	KeyHistoryImportButton:          "Import",
	KeyHistoryImportSummary:         "Import done: written %d session(s), skipped %d session(s), cancelled %d remaining. Memory: %s",
	KeyHistoryCollisionTitle:        "Session already exists",
	KeyHistoryCollisionBody:         "Session %s already exists at destination",
	KeyHistoryCollisionMemoryTitle:  "Memory directory already exists",
	KeyHistoryCollisionMemoryBody:   "memory/ already exists at destination",
	KeyHistoryCollisionOverwrite:    "Overwrite",
	KeyHistoryCollisionSkip:         "Skip this session",
	KeyHistoryCollisionCancelAll:    "Cancel entire import",
	KeyHistoryYes:                   "yes",
	KeyHistoryNo:                    "no",
