...
- Task Execution Order section sequences the groups correctly and emits the post-batch `git cherry-pick` + `git worktree remove` integration block for each `[P]` group
